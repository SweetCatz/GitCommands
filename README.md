...
- `git add  <файл>` - подготавливает измененный или созданный файл к следующему коммиту, добавляя его в "индекс". "Индекс" - это хранилище файлов, готовых к коммиту (фиксации). 
